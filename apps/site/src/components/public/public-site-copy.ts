...
const roadmapKeys = ["roadmap", "roadmapIntro", "current", "overall", "planned", "complete", "allComplete", "tasks", "scopePending", "roadmapLoading", "roadmapUnavailable", "progressNote", "updated"] as const;
