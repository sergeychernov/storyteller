...
const timeline: StoryTimeline = {
  ...
  scenes: [
    { sceneId: "empty-1", index: 0, materialIds: [], startSeconds: 0, endSeconds: 0, durationSeconds: 0, startFrame: 0, endFrame: 0, durationFrames: 0, durationSource: "empty" },
    { sceneId: "video", index: 1, materialIds: ["video-1"], startSeconds: 0, endSeconds: 2.75, durationSeconds: 2.75, startFrame: 0, endFrame: 82, durationFrames: 82, durationSource: "trim" },
    { sceneId: "empty-2", index: 2, materialIds: [], startSeconds: 2.75, endSeconds: 2.75, durationSeconds: 0, startFrame: 82, endFrame: 82, durationFrames: 0, durationSource: "empty" },
    { sceneId: "photo", index: 3, materialIds: ["photo-1"], startSeconds: 2.75, endSeconds: 7.75, durationSeconds: 5, startFrame: 82, endFrame: 232, durationFrames: 150, durationSource: "scene" },
  ],
  frameRate: { numerator: 30, denominator: 1 }, totalFrames: 232, totalDurationSeconds: 7.75,
