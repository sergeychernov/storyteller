...
const routePolicies = new Map<string, RouteAccessPolicy>([
  ...
  route("POST", "/stories/:storyId/exports", "story.export"),
  route("GET", "/stories/:storyId/exports/current", "story.export"),
  route("GET", "/stories/:storyId/exports/:exportId", "story.export"),
  route("GET", "/stories/:storyId/exports/:exportId/content", "story.export"),
